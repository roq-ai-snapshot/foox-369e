...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Job Application.create': { roles: ['owner', 'recruiter'], key: 'jobApplicationId', tenantPath: [], userPath: [] },
  'Job Posting.create': { roles: ['owner', 'recruiter'], key: 'jobPostingId', tenantPath: [], userPath: [] },
  'Job Application Review.update': {
