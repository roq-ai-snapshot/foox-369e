  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox - Your One-Stop Job Marketplace for Freelancers. Where Companies Meet Talent and Dreams Turn Into Reality."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox - Your One-Stop Job Marketplace for Freelancers. Where Companies Meet Talent and Dreams Turn Into Reality.`}
            </Text>
            <Box
